...
void calcfreq(int st,int vathm[st],int mgr,int count,int un[mgr],int freq[mgr]);
void findmaxfreq(int count,int mgr,int freq[mgr],int un[mgr],int *maxvath,int *maxfr);
...
printf("O vathmos pou paratirithike tis perissoteres fores einai o %d kai paratirithike %d fores\n",maxvathmos,maxfreq);
