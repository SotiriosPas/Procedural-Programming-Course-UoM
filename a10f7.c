...
{
int i,y;
char word[rows][columns]={"kiss","crucifix","beach","ash","apology","toy","light"};
char temp[columns];
...
void RegularPluralForm(int c,char word[c])
{
    ...
    if (word[finalletter]=='s' || word[finalletter]=='x' || (word[finalletter-1]=='c' && word[finalletter]=='h' ) || (word[finalletter-1]=='s' && word[finalletter]=='h' ))
    {
        word[finalletter+1]='e';
        word[finalletter+2]='s';
        word[finalletter+3]='\0';
    }
    else if ((word[finalletter]=='y') && (!(isVowel(word[finalletter-1]))))
    {
       word[finalletter]='i';
       word[finalletter+1]='e';
       word[finalletter+2]='s';
